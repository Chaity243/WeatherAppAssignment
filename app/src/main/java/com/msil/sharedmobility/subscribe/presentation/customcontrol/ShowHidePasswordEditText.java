...
public class ShowHidePasswordEditText extends EditText {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            visibilityIndicatorShow = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_show, R.drawable.ic_remove_black_24dp);
            visibilityIndicatorHide = attrsArray.getResourceId(R.styleable.ShowHidePasswordEditText_drawable_hide, R.drawable.ic_hide_eye);
            ...
            visibilityIndicatorShow = R.drawable.ic_remove_black_24dp;
            visibilityIndicatorHide = R.drawable.ic_hide_eye;
        ...
        //note this must be set before maskPassword() otherwise it was the passwordTransformation
        setSingleLine(true);
        ...
        addTextChangedListener(new TextWatcher() {
            ...
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                Log.d("Password", s + " before");
            }

            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                Log.d("Password", s + " on text");
                if (s.length() > 0) {
                    showPasswordVisibilityIndicator(true);
                } else {
    ...
    private void showPasswordVisibilityIndicator(boolean show) {
        ...
        if (show) {
            ...
            Objects.requireNonNull(original).mutate();
